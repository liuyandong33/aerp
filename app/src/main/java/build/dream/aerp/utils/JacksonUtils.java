...
public class JacksonUtils {
    ...
    public static String writeValueAsString(Object object, String datePattern, JsonInclude.Include serializationInclusion) {
        try {
            return obtainObjectMapper(datePattern, serializationInclusion).writeValueAsString(object);
        } catch (Exception e) {
    ...
    public static <T> T readValue(String content, Class<T> clazz, String datePattern) {
        try {
            return obtainObjectMapper(datePattern, null).readValue(content, clazz);
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
    }
